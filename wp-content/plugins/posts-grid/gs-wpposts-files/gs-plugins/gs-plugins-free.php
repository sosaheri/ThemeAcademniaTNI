...
if( ! class_exists( 'GSPosts_Grid_free' ) ){
    
    class GSPosts_Grid_free{
        ...
        public static function get_instance() {
            if ( ! self::$_instance instanceof GSPosts_Grid_free ) {
                self::$_instance = new GSPosts_Grid_free();
            }
    ...
    $gsplugin_free = GSPosts_Grid_free::get_instance();
}