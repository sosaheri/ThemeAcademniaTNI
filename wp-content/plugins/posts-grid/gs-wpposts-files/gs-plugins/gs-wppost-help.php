...
function gs_wpposts_help_menu() {
	...
	add_submenu_page( 
	    ...
	    'manage_options', 
	    'gs-posts-grid', 
	    'gsposts_grid_help_menu_cb'
	);
}

add_action('admin_menu', 'gs_wpposts_help_menu', 11);

function gsposts_grid_help_menu_cb() {
	?>

    <div class="wrap">
        
    	<div class="gs_team_wrap gs_brand_help" style="width: 845px; float: left; margin-top: 50px; text-align: center;">
	        <h1>WordPress Posts Grid by GS Plugins</h1>
			<br>
			<a class="gstm-hlp-btn gstm-btn-1" href="https://www.gsamdani.com/product/wordpress-posts-grid" target="_blank">Plugin Home</a>
			<a class="gstm-hlp-btn gstm-btn-2" href="http://posts-grid.gsamdani.com" target="_blank">Live Demo</a>
			<a class="gstm-hlp-btn gstm-btn-3" href="http://posts-grid.gsamdani.com/documentation" target="_blank">Documentation</a>
			<a class="gstm-hlp-btn gstm-btn-4" href="http://posts-grid.gsamdani.com/documentation/#GS_Posts_Grid8217s_shortcode_usage" target="_blank">Shortcode Usage</a>
            ...
            <b><i>Video Coming Soon!</i></b>
        </div>
        
        <div class="gs-posts-grid-admin-sidebar" style="width: 277px; float: left; margin-top: 62px; text-align: center;">
            <div class="postbox">
