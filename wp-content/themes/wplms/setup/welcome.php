		...
		<div class="wrap wplms-wrap about-wrap">
			...
			<div class="changelog">
				<div class="wplms-feature feature-rest feature-section col two-col">
					<div class="col-1">
						...
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/3-3/" class="button"><?php _e( 'Check update log ', 'vibe' ); ?></a>
					</div>
					<div class="col-2">
						<h4>Improvements in Customizer - Layout</h4>
						<p>You now see layout thumbnails in Customizer - Layouts section.</p>
			...
			<div class="changelog about-integrations">
				...
				<div class="wplms-feature feature-section col three-col">
					<div>
						<h4>Layout Thumbnails</h4>
						<p style="max-height: 230px; overflow: hidden;">
							<img src="https://image.prntscr.com/image/304U2qcSRP_PLRv03HmTTA.png">
						</p>
					</div>
					<div class="last-feature">
						<h4>Blank Course Template</h4>
						<p style="max-height: 230px; overflow: hidden;"><img src="https://image.prntscr.com/image/J137cqz1QVWa6U-Sc09C_g.png" /></p>
					</div>
					<div>
						<h4>Search API Connected clients</h4>
						<p style="max-height: 230px; overflow: hidden;">
							<img src="https://image.prntscr.com/image/8IHPj6hyThaW1dQt2lLbDQ.png">
						</p>
					</div>
				</div>
