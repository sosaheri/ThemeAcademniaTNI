	...
	class Envato_Theme_Setup_Wizard {
		...
		public function init_globals() {
			...
			$this->site_styles = array(
                ...
                'demo7' => array('label'=>'Demo 7','link'=>'http://themes.vibethemes.com/wplms/skins/demo7/'),
                'demo8' => array('label'=>'Demo 8','link'=>'http://themes.vibethemes.com/wplms/skins/demo8/'),
                'default' => array('label'=>'Default','link'=>'http://themes.vibethemes.com/wplms/skins/default/'),
                'points_system' => array('label'=>'Points System','link'=>'http://themes.vibethemes.com/wplms/skins/points_system/'),
                'oneinstructor' => array('label'=>'One Instructor','link'=>'http://themes.vibethemes.com/wplms/skins/oneinstructor/'),
                'onecourse' => array('label'=>'One Course','link'=>'http://themes.vibethemes.com/wplms/skins/onecourse/'),
                'childone' => array('label'=>'Child One','link'=>'http://themes.vibethemes.com/wplms/skins/childone/'),
                'modern' => array('label'=>'Modern','link'=>'http://themes.vibethemes.com/wplms/skins/modern/'),
            );
			...
			if ( ! $upload || $upload['error'] ) {
				...
				if ( empty( $this->debug ) ) {
					...
					if( !empty($path) ){
						...
						if(strpos($url, 'http://local.wordpress.dev') !== false){
